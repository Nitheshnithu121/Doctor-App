                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView(
                          ...
                          children: [
                            categoryContainer("ctscan.png", "CT-Scan"),
                            categoryContainer("img2.png", "Ortho"),
                            categoryContainer("img3.png", "Dietitian"),
                            categoryContainer("img4.png", "Physician"),
                            categoryContainer("img5.png", "Paralysis"),
                            categoryContainer("img6.png", "Cardiology"),
                            categoryContainer("img7.png", "MRI - Scan"),
                            categoryContainer("img8.png", "Gynaecology"),

                          ],
                        ),
                      ),
                      Text("Chief Doctor's", style: TextStyle(
                        fontSize: 25,
                      ...
                      Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              createDocWidget("doc1.png", "Susan Sharma"),
                              createDocWidget("doc2.png", "Varsh Ramesh"),
                              createDocWidget("doc3.png", "Nancy Williams"),
                              createDocWidget("doc6.png", "Ramesh Kamath"),
                              createDocWidget("doc5.png", "Aishwarya Sharama"),
                              createDocWidget("doc4.png", "Shreepathi Rao"),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: 250,
                      height: 50,
                      child: Text("A brief about the doctor added here. This is more like an introduction about the doctor", style: TextStyle(
                        fontSize: 12,
